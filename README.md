...
========================
Motivation:
Flume can places data into a directory on HDFS and rolls files based on a configuration.
...
Right now all files in the last N minutes - triggered by oozie


TODO:
write down a file that is the last file to be processed in a ./tickets directory
this will be read to see what was last processed.
